                  ...
                  {filteredOrders.length > 0 ? (
                    filteredOrders.map((order, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          <span className={`cod-badge ${order.paymentMethod === 'COD' ? 'cod' : 'prepaid'}`}>
                            {order.paymentMethod}
                          </span>
                        </td>
                        <td>
                        ...
                        <td>{order.placedDate || order.date || '-'}</td>
                        <td>{order.deliveredDate ? order.deliveredDate : '-'}</td>
                        <td>
                          <div className="action-buttons">
                            ...
                            <button className="action-btn" title="Confirm">
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
