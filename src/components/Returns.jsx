                  ...
                  {filteredReturns.length > 0 ? (
                    filteredReturns.map((returnItem, index) => (
                      <tr key={index}>
                        ...
                        <td>{returnItem.customer?.name || returnItem.customer}</td>
                        <td>{returnItem.product?.name || returnItem.product}</td>
                        <td>
                          <span className="reason-tag" style={{ color: getReasonColor(returnItem.reason) }}>
                            {returnItem.reason}
                          </span>
                        </td>
                        <td>{returnItem.date || new Date(returnItem.createdAt).toISOString().split('T')[0]}</td>
                        <td>${returnItem.amount?.toFixed(2)}</td>
                        <td>
