...
function Settings() {
  ...
  const handleIntegrationToggle = (platform) => {
    if (platform === 'shopify') {
      setIntegrations({
        ...integrations,
        shopify: { ...integrations.shopify, connected: !integrations.shopify.connected }
      })
    } else if (platform === 'wooCommerce') {
      setIntegrations({
        ...integrations,
        wooCommerce: { ...integrations.wooCommerce, connected: !integrations.wooCommerce.connected }
      })
    }
  }
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="settings-section">
            ...
            <div className="integration-card">
              ...
              <p className="integration-description">Connect your Shopify store</p>
              {integrations.shopify.connected && (
                <p className="integration-status-text">
                  Last scan {integrations.shopify.lastScan} & Imported {integrations.shopify.importedOrders} orders.
                </p>
              )}
              <button
                type="button"
                className={`integration-btn ${integrations.shopify.connected ? 'disconnect' : 'connect'}`}
                onClick={() => handleIntegrationToggle('shopify')}
              >
                {integrations.shopify.connected ? 'Disconnect' : 'Connect'}
              </button>
            </div>
